...
assertIncludes(app, "feedMessageDeepLinkService", "canonical feed deep-link service");
assertIncludes(app, "openAuthorizedCommunityMessage", "authorized community message open");
assertIncludes(app, "highlightMessageTemporarily", "exact message highlight timer");
...
assertExcludes(app, "Message highlight is a placeholder.", "placeholder highlight toast");
