...
assertIncludes(builderConfig, "artifactName: Picom-${version}-${channel}-Windows-${arch}.${ext}", "Windows artifact name");
assertIncludes(builderConfig, "artifactName: Picom-${version}-${channel}-Linux-${arch}.${ext}", "Linux artifact name");
assertIncludes(builderConfig, "artifactName: Picom-${version}-${channel}-macOS-${arch}.${ext}", "macOS artifact name");
