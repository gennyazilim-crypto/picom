...
for (const marker of ["suspended", "crossCommunityDenied", "tokenRefreshPassed", "tokenTtlCanonicalIdentityPassed", "oversizedBodyDenied"]) assert.ok(read("scripts/livekit-token-member-hosted-fixture.mjs").includes(marker), `hosted security fixture missing ${marker}`);
