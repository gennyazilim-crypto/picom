...
const nestedApis = ["getSources", "selectSource", "cancelSelection", "setStatus", "setMuted", "setCloseToTray", "showWindow", "quit", "onAction", "getState", "setEnabled", "pickImages", "saveText", "readText", "writeText", "openUrl", "onOpen", "onResume"];
...
if (channelKeys.length !== 22) throw new Error(`Expected 22 frozen IPC channels, found ${channelKeys.length}`);
...
if (handlerCount !== 18 || trustCheckCount !== handlerCount) throw new Error(`Every IPC handler must validate its sender (handlers=${handlerCount}, checks=${trustCheckCount})`);
