...
for (const marker of ["cameraStream", "handRaised", "microphoneEnabled", "isSpeaking", "aria-pressed", "setVideoSubscriptions"]) assert.ok(focus.includes(marker), `focus/filmstrip missing ${marker}`);
