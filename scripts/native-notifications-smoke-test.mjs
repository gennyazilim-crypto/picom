...
const required = [
  ...
  [text.service, 'disableNativeNotifications'],
  [text.service, 'routing?: Omit<NotificationRouteContext, "category">'],
  [text.service, '"system-controlled"'],
  [text.service, 'showTestNotification'],
  [text.main, 'parseNotificationPayload'],
  [text.main, 'isTrustedAppUrl(event.sender.getURL())'],
  [text.main, 'Notification.isSupported()'],
  [text.main, 'new Notification'],
  [text.main, 'function handleNativeDeepLink'],
  [text.main, 'focusMainWindow();'],
  [text.main, 'handleNativeDeepLink(safePayload.deepLink)'],
  [text.main, 'IPC_CHANNELS.notificationSendTest'],
  [text.main, 'isTrustedMainWindowIpcEvent(event)'],
  [text.preload, 'showNotification'],
  [text.preload, 'IPC_CHANNELS.notificationShow'],
  [text.preload, 'IPC_CHANNELS.notificationSendTest'],
