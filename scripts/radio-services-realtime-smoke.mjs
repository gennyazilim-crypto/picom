...
for (const marker of ["radioRealtimeService.subscribe", "refreshTimer", "unsubscribeRealtime", "RealtimeConnectionStatus", "loading", "error"]) if (!hook.includes(marker)) throw new Error(`Audio catalog hook missing ${marker}`);
