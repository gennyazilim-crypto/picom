...
const checks = [
  ...
  [settings.includes("Request data export placeholder"), "data export action"],
  [settings.includes("Account deletion status placeholder"), "account deletion status action"],
