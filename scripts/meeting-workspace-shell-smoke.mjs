...
const workspace=read("src/components/meeting/MeetingWorkspace.tsx"),top=read("src/components/meeting/MeetingTopBar.tsx"),stage=read("src/components/meeting/MeetingStage.tsx"),dock=read("src/components/meeting/MeetingRightDock.tsx"),controls=read("src/components/meeting/MeetingControlDock.tsx"),surfaces=read("src/components/meeting/MeetingWorkspaceSurfaces.tsx"),lazy=read("src/components/meeting/MeetingWorkspaceLazy.tsx"),css=read("src/components/meeting/MeetingWorkspace.css");
...
assert.ok(stage.includes('aria-label="Meeting media stage"')&&dock.includes('aria-label="Meeting side panel"')&&controls.includes('aria-label="Meeting controls"'),"structural regions must be keyboard accessible");
