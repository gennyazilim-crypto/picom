...
const checks=[
 ...
 ["kind-aware scoped permissions",["viewVoiceRoom","joinVoiceRoom","publishAudio","shareScreen","viewPrivateChannels"].every((permission)=>migration.includes(`'${permission}'`))],
 ["radio broadcast remains separate",authorizationSql.includes("target_community.kind<>'text'::public.community_kind")&&!authorizationSql.includes("hostRadio")&&!authorizationSql.includes("listenRadio")],
