...
assert.ok(/audio\s*:\s*false/.test(service)&&/meetingService\.join\(next,\s*true\)/.test(service)&&service.includes("joinMuted")&&service.includes("joinCameraOff"),"preview isolation or real join choices missing");
