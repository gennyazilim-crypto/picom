...
for (const marker of ["REPORT_SECRET_PATTERN", "canTransitionReportStatus", "if (!input.canReview)", "visible community context", "auditLogService.append"]) assert.ok(service.includes(marker), `Missing report service hardening marker: ${marker}`);
