...
for (const marker of ["AudioFeedSection", "useAudioCatalog", "selectedAudio", "savedAudioIds", "audioReminderFeedIds", "useRadioScheduleReminders"]) if (!main.includes(marker)) throw new Error(`Mention Feed audio integration missing: ${marker}`);
