...
for (const marker of ["AudioFeedSection", "useAudioCatalog", "selectedAudio", "savedAudioIds", "audioReminderIds"]) if (!main.includes(marker)) throw new Error(`Mention Feed audio integration missing: ${marker}`);
