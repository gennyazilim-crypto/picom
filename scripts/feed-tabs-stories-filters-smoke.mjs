...
assert.ok(tabs.includes("Feed")&&tabs.includes("Takip Ettiğin Kişiler"),"two Feed tabs must remain");
...
assert.ok(css.includes("overflow-x: auto")&&css.includes("max-width: 100%"),"story row overflow contract missing");
