...
const files = {
  ...
  onboarding: read("src/components/CommunityOnboardingChecklist.tsx"),
  onboardingService: read("src/services/communityOnboardingService.ts"),
...
const checks = [
  ...
  ["branding rules and kinds", (files.settings.includes('communitySettings.chooseBanner') || files.settings.includes('communitySettings.replaceBanner')) && files.settings.includes('communitySettings.rules') && files.settingsMigration.includes("valid_community_type_settings")],
  ...
  ["onboarding tasks open real management surfaces", files.onboarding.includes("onOpenTask") && files.deferred.includes("onOpenOnboardingTask") && files.onboardingService.includes("Choose the default notification behavior") && !files.onboardingService.includes("notification behavior placeholder")],
