...
assert.match(presence,/setInterval\(scheduleRefresh, 30_000\)/);assert.match(presence,/list_friend_presence/);assert.match(globalPresence,/set_my_presence_session/);assert.match(globalPresence,/channel\.track/);assert.match(globalPresence,/30_000/);assert.doesNotMatch(presence,/profile.*statusText|payload.*statusText/i);
