...
for(const marker of ["notificationService.showNotification","settings.enabled","settings.muted","settings.mentionsOnly","minutesBefore"])if(!reminder.includes(marker))throw new Error(`Reminder service missing ${marker}`);
