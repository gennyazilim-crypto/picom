...
2. Updated diagnostics coverage to the aggregate `voiceDiagnosticsRegistry`; safe diagnostics may report a disabled provider, but they do not require the conditional Voice product to be enabled.
