...
- Staging rollout compatibility: forward migration `20260712166510` supplies the multi-role hierarchy helper absent from the older hosted migration subset, without replaying unrelated Task 645 schema work.
