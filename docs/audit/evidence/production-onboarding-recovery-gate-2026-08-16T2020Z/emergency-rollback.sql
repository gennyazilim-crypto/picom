...
-- SOURCE: ACTUAL PRODUCTION PRE-MUTATION STATE
-- project: picom-production / cqnsetsmcduraryemhbi
-- captured_at: 2026-08-16T2020Z
-- oid: 21328
-- DO NOT EXECUTE unless post-apply verification fails.
...
grant execute on function public.complete_current_user_onboarding(jsonb, uuid[], text) to service_role;
