...
Permanent SMTP responses produce suppressions and prevent repeat attempts. Complaints require provider feedback evidence; no webhook is claimed. Operators must review provider mailbox signals and update suppressions until an authenticated feedback integration is available.
