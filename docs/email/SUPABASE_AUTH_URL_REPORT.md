# Supabase Auth URL Report

**Status:** LIVE MANAGEMENT CONFIGURATION SCHEDULED IN THIS CHECKPOINT

**Reviewed:** 2026-07-15

## Result

The hosted Site URL is updated from `http://localhost:3000` to `https://picom.gg`. Exact desktop deep links, the local Vite development origin, and exact production HTTPS auth paths are allowlisted without broad wildcards. Local config retains localhost for development.
