...
Production scope covers Supabase Auth mail plus transactional product mail. It excludes bulk marketing automation, arbitrary relaying, mailbox administration, and client-side SMTP.
