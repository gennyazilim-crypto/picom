...
Normal users manage only their preferences and submissions. Support agents use support records, not queue internals. App admins/root owners may view operational metadata and retry/cancel. Only the service role may claim/complete messages or mutate suppressions programmatically.
