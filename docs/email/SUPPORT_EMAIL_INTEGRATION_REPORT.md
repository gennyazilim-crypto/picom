# Support Email Integration Report
...
Help & Support now submits authenticated requests to the protected queue and reports queued status honestly. Offline mode copies a redacted report instead. Diagnostics are never attached without an explicit export action.
