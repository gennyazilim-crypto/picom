...
The root dashboard includes Email Operations with queue metrics, recent operations, protected retry/cancel actions, and a test message constrained to the signed-in admin address. It never exposes message bodies or SMTP credentials.
