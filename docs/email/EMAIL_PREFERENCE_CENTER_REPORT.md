# Email Preference Center Report
...
Settings > Notifications loads and persists email preferences through the Edge API. Required account/security mail cannot be disabled; optional digest and marketing are off by default.
