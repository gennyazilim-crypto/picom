...
The worker renders allowlisted template IDs from structured parameters to escaped HTML and plain text. URLs and header-like values are validated. Unknown templates, locales, or categories fail closed.
