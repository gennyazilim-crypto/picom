# Nginx Email API Report

**Status:** SAFE BOUNDARY DEFINED

**Reviewed:** 2026-07-15

## Result

Public email intents terminate at Supabase email-api. Nginx exposes only the worker health route to localhost; it does not proxy SMTP or provide a generic mail relay endpoint.
