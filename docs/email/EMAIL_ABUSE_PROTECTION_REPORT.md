...
Public contact uses origin allowlisting, Turnstile, salted rate buckets, size limits, fixed recipients, and allowlisted templates. Authenticated/admin actions use JWT and RBAC. Idempotency prevents duplicate queue entries.
