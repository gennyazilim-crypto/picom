...
values ('83000000-0000-0000-0000-000000000001', '82000000-0000-0000-0000-000000000001', '72000000-0000-0000-0000-000000000001', 'RLS Org A LLC', 'RLS Org A', 'company', 'DE', 'Test Street 1', 'Owner', 'submitted', now(), 'INTERNAL_ONLY_NOTES')
on conflict (id) do nothing;
