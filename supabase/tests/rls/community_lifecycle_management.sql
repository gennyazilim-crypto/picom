...
select throws_like($$select * from public.transfer_community_ownership('a1200000-0000-4000-8000-000000000001','a1100000-0000-4000-8000-000000000002','Lifecycle Text')$$,'%COMMUNITY_TRANSFER_OWNER_REQUIRED%','non-owner cannot transfer ownership');
reset role;

select set_config('request.jwt.claim.sub','a1100000-0000-4000-8000-000000000001',true);
set local role authenticated;
select throws_like($$select * from public.transfer_community_ownership('a1200000-0000-4000-8000-000000000001','a1100000-0000-4000-8000-000000000003','Lifecycle Text')$$,'%COMMUNITY_TRANSFER_TARGET_NOT_MEMBER%','ownership target must be a current member');
select lives_ok($$select * from public.transfer_community_ownership('a1200000-0000-4000-8000-000000000001','a1100000-0000-4000-8000-000000000002','Lifecycle Text')$$,'owner can transfer ownership atomically');
reset role;
