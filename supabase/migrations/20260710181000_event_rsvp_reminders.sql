...
alter table public.community_event_rsvps enable row level security; alter table public.community_event_reminders enable row level security;
grant select on public.community_event_rsvps to authenticated; grant select,insert,update,delete on public.community_event_reminders to authenticated;
