...
begin
  ...
  select * into target_community from public.communities
  ...
  select * into target_channel from public.channels
  where id=target_channel_id and community_id=target_community_id and type='voice';
