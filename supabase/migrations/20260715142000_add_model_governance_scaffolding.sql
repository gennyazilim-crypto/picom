...
create policy "model registry admin read" on public.model_registry for select using (is_admin());
...
create policy "model deployments admin read" on public.model_deployments for select using (is_admin());
...
create policy "model drift admin read" on public.model_drift_metrics for select using (is_admin());
...
create policy "model predictions admin read" on public.model_predictions for select using (is_admin());
...
create policy "feedback events admin read" on public.feedback_events for select using (is_admin());
