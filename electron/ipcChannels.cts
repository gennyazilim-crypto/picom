export const IPC_CHANNELS = Object.freeze({
  ...
  appearanceSetInterfaceScale: "picom:appearance-set-interface-scale",
  ...
  notificationGetCapability: "picom:notification-get-capability",
  notificationSendTest: "picom:notification-send-test",
  desktopNotificationToastShow: "picom:desktop-notification-toast-show",
  desktopNotificationToastAction: "picom:desktop-notification-toast-action",
  desktopNotificationToastEvent: "picom:desktop-notification-toast-event",
  ...
  settingsSetLocale: "picom:settings-set-locale",
