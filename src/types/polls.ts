...
export type PollData = Readonly<{ id: string; messageId: string; question: string; allowMultiple: boolean; closesAt?: string; closedAt?: string; createdAt: string; options: PollOption[] }>;
