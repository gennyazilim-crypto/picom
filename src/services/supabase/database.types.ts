...
export type Database = {
  public: {
    Tables: {
      ...
      meeting_sessions: {
        Row: { id:string;room_id:string;provider:"livekit";provider_room_name:string;status:"preparing"|"live"|"reconnecting"|"ended"|"failed";connection_state:string;started_by_user_id:string;ended_by_user_id:string|null;started_at:string|null;ended_at:string|null;duration_seconds:number|null;outcome_code:"provider_ended"|"host_ended"|"failed"|"cancelled"|"unknown"|null;outcome_source:"verified_livekit_webhook"|"backend_control"|"provider_failure"|"unknown"|null;outcome_verified_at:string|null;participant_count:number;last_event_sequence:number;idempotency_key:string;metadata:Json;created_at:string;updated_at:string };
    ...
    Functions: {
      ...
      create_text_community_with_defaults: {
        Args: {
          ...
          community_visibility?: "public" | "private" | "secret";
      ...
      create_secret_community: { Args: { target_creation_request_id: string; target_kind: "text" | "radio" | "podcast"; community_name: string; community_description?: string | null; community_icon_url?: string | null; community_accent_color?: string; community_template_id?: string }; Returns: Array<Database["public"]["Tables"]["communities"]["Row"]> };
      update_secret_community_settings: { Args: { target_community_id: string; next_name: string | null; next_description: string | null; next_icon_url: string | null; next_banner_url: string | null; next_visibility: "secret"; next_public_read_enabled: boolean | null; next_default_notification_level: "all" | "mentions" | "none" | null; next_rules_enabled: boolean | null; next_rules_version: string | null; next_type_settings: Json | null; next_rules: Json | null }; Returns: Array<Database["public"]["Tables"]["communities"]["Row"]> };
      update_community_settings: {
        Args: { target_community_id: string; next_name: string | null; next_description: string | null; next_icon_url: string | null; next_banner_url: string | null; next_visibility: "public" | "private" | "secret" | null; next_public_read_enabled: boolean | null; next_default_notification_level: "all" | "mentions" | "none" | null; next_rules_enabled: boolean | null; next_rules_version: string | null; next_type_settings: Json | null; next_rules: Json | null };
        Returns: Array<Database["public"]["Tables"]["communities"]["Row"]>;
      };
      ...
      list_root_dashboard_module_v1: { Args: { module_name: string; page_cursor_created_at?: string | null; page_cursor_id?: string | null; page_limit?: number }; Returns: Json };
      get_root_dashboard_overview_v1: { Args: Record<string, never>; Returns: Json };
      get_root_dashboard_module_summary_v1: { Args: { module_name: string }; Returns: Json };
      is_root_owner: { Args: Record<string, never>; Returns: boolean };
      has_platform_permission: { Args: { permission_key: string }; Returns: boolean };
      has_platform_role: { Args: { target_role: string }; Returns: boolean };
      create_support_ticket: { Args: { p_subject: string; p_category?: string; p_priority?: string; p_requester_id?: string | null; p_tags?: string[]; p_reason?: string | null; p_case_id?: string | null; p_correlation_id?: string | null }; Returns: string };
      update_support_ticket_status: { Args: { p_ticket_id: string; p_status: string; p_reason?: string | null; p_case_id?: string | null; p_correlation_id?: string | null }; Returns: boolean };
      assign_support_ticket: { Args: { p_ticket_id: string; p_assignee_id: string; p_reason?: string | null; p_case_id?: string | null; p_correlation_id?: string | null }; Returns: boolean };
      upsert_ad_campaign: { Args: { p_id?: string | null; p_name?: string | null; p_advertiser_label?: string; p_objective?: string; p_budget_cents?: number; p_schedule_start?: string | null; p_schedule_end?: string | null; p_reason?: string | null; p_case_id?: string | null; p_correlation_id?: string | null }; Returns: string };
      set_ad_campaign_status: { Args: { p_campaign_id: string; p_status: string; p_reason?: string | null; p_case_id?: string | null; p_correlation_id?: string | null }; Returns: boolean };
      set_ad_review_status: { Args: { p_campaign_id: string; p_review_status: string; p_reason?: string | null; p_case_id?: string | null; p_correlation_id?: string | null }; Returns: boolean };
      create_platform_incident: { Args: { p_title: string; p_severity: string; p_affected_services?: string[]; p_public_message?: string | null; p_owner_id?: string | null; p_reason?: string | null; p_case_id?: string | null; p_correlation_id?: string | null }; Returns: string };
      update_platform_incident_status: { Args: { p_incident_id: string; p_status: string; p_reason?: string | null; p_case_id?: string | null; p_correlation_id?: string | null }; Returns: boolean };
      create_finance_approval_request: { Args: { p_request_type: string; p_amount_cents: number; p_currency?: string; p_reason?: string | null; p_case_id?: string | null; p_correlation_id?: string | null }; Returns: string };
      review_finance_approval_request: { Args: { p_request_id: string; p_decision: string; p_step_up_challenge_id?: string | null; p_reason?: string | null; p_case_id?: string | null; p_correlation_id?: string | null }; Returns: boolean };
      upsert_remote_feature_flag: { Args: { p_flag_key: string; p_enabled: boolean; p_description?: string; p_step_up_challenge_id?: string | null; p_reason?: string | null; p_case_id?: string | null; p_correlation_id?: string | null }; Returns: boolean };
      assign_platform_role: { Args: { p_user_id: string; p_role_key: string; p_scope_type?: string; p_expires_at?: string | null; p_step_up_challenge_id?: string | null; p_reason?: string | null; p_case_id?: string | null; p_correlation_id?: string | null }; Returns: string };
      revoke_platform_role: { Args: { p_assignment_id: string; p_step_up_challenge_id?: string | null; p_reason?: string | null; p_case_id?: string | null; p_correlation_id?: string | null }; Returns: boolean };
      upsert_subscription_record: { Args: { p_external_ref: string; p_plan_key: string; p_status: string; p_currency?: string; p_mrr_cents?: number; p_region_code?: string | null; p_subscriber_ref?: string | null; p_current_period_end?: string | null; p_canceled_at?: string | null; p_reason?: string | null; p_case_id?: string | null; p_correlation_id?: string | null }; Returns: string };
      create_privileged_step_up: { Args: { action_key: string }; Returns: string };
      confirm_privileged_step_up: { Args: { challenge_id: string }; Returns: boolean };
