...
export type Database = {
  public: {
    ...
    Functions: {
      ...
      authorize_livekit_room: { Args: { target_community_id: string; target_channel_id: string; target_intent: "voice" | "screen" }; Returns: Array<{ community_id: string; channel_id: string; community_kind: "text"; channel_private: boolean; can_publish_audio: boolean; can_publish_screen: boolean }> };
