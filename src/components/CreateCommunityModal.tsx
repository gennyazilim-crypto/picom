...
export function CreateCommunityModal({ onClose, onSubmit }: CreateCommunityModalProps) {
  ...
  const submit = async () => {
    ...
    if (visibility === "secret" && !secretEligible) { setError("Complete phone and SMS verification before creating a secret community."); return; }
