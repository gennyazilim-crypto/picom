...
const KIND_OPTIONS: readonly KindOption[] = [
  { kind: "text", title: "Text Community", description: "A structured space for channels, messages, files, roles, and voice rooms.", capabilities: ["Text and voice channels", "Replies, reactions, and attachments", "Roles, moderation, and audit log"], limitation: "Does not publish live radio or podcast episodes.", icon: "hash" },
