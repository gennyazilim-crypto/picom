    ...
    <main className="first-launch-setup" aria-label="Picom first launch setup">
      <section className="first-launch-frame" aria-live="polite">
        ...
        <div className="first-launch-content">
          ...
          {current.id === "permissions" ? <div className="first-launch-step"><p className="eyebrow">Your control</p><h1>Permissions are requested only when needed</h1><p>Setup explains permissions but never opens a system prompt.</p><div className="first-launch-card-grid"><PermissionCard icon="bell" title="Notifications">Requested later when you choose to enable desktop alerts.</PermissionCard><PermissionCard icon="microphone" title="Microphone">Requested only when you join voice and enable your microphone.</PermissionCard><PermissionCard icon="image" title="Screen sharing">The source picker opens only after you choose to share a screen.</PermissionCard></div></div> : null}
