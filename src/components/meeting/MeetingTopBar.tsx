...
export function MeetingTopBar({snapshot,focusMode,onToggleFocus,onToggleDock}:{snapshot:MeetingClientSnapshot;focusMode:boolean;onToggleFocus:()=>void;onToggleDock:()=>void}) {
