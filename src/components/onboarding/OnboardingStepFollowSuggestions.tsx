...
export function OnboardingStepFollowSuggestions({ suggestions, followedUserIds, onToggleFollow }: Props) {
  return (
    <section className="onboarding-step" aria-labelledby="onboarding-follow-title">
      <div className="onboarding-step-heading"><span className="onboarding-step-icon"><AppIcon name="users" size="lg" /></span><div><p className="eyebrow">Follow suggestions</p><h2 id="onboarding-follow-title">Build a useful feed</h2><p>Follow a few people so Takip Ettiğin Kişiler is useful from day one.</p></div></div>
