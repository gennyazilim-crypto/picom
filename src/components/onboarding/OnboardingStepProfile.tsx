  ...
  return (
    <section className="onboarding-step" aria-labelledby="onboarding-profile-title">
      <div className="onboarding-step-heading">
        ...
        <div><p className="eyebrow">Profile basics</p><h2 id="onboarding-profile-title">Make Picom feel like yours</h2><p>Your display name, username, and status help people recognize you across communities.</p></div>
      </div>
      <div className="onboarding-profile-layout">
        ...
        <div className="onboarding-fields">
          ...
          <label><span>Username <em>Optional</em></span><input maxLength={32} value={value.username} onChange={(event) => onChange({ ...value, username: event.target.value })} placeholder="your-handle" /></label>
