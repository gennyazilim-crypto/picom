...
export function FeedbackModal({ onClose, onNotice }: Props) {
  ...
  const copy = async () => {
    if (!title.trim() || !description.trim()) {
      onNotice("Add a title and description before copying the report.", "error");
      return;
    }
