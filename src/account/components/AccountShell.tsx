...
const NAV_SECTIONS: NavSection[] = [
  {
    ...
    items: [
      ...
      { to: ROUTES.verified, labelKey: "nav.verified", Icon: IconBadge },
      { to: ROUTES.accountBilling, labelKey: "nav.billing", Icon: IconKey },
      { to: ROUTES.accountVerification, labelKey: "nav.accountVerification", Icon: IconShield },
      { to: ROUTES.business, labelKey: "PICOM Business", Icon: IconBadge },
      { to: ROUTES.advertise, labelKey: "Advertise", Icon: IconBadge },
    ],
  },
  {
...
const PAGE_TITLES: Record<string, string> = {
  ...
  [ROUTES.verified]: "nav.verified",
  [ROUTES.verifiedCheckout]: "nav.verified",
  [ROUTES.verifiedStatus]: "nav.verifiedStatus",
  [ROUTES.accountBilling]: "nav.billing",
  [ROUTES.accountVerification]: "nav.accountVerification",
  [ROUTES.business]: "PICOM Business",
  [ROUTES.businessApply]: "PICOM Business",
  [ROUTES.businessDashboard]: "PICOM Business",
  [ROUTES.advertise]: "Advertise",
  [ROUTES.advertiseCreateAccount]: "Advertise",
  [ROUTES.advertiserDashboard]: "Advertiser",
