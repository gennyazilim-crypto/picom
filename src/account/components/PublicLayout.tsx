...
import { openMarketingConsentSettings } from "../../components/marketing/MarketingConsentBoundary";
    ...
    <div className="ac-public">
        ...
        <nav className="ac-public__nav" aria-label="Primary">
          <div className="ac-public__nav-group">
            ...
            <NavLink
              ...
              onClick={() => trackMarketingEvent("signup_cta_clicked")}
            >
              {t("home.register")}
            </NavLink>
      ...
      <footer className="ac-public__footer">
        <div className="ac-public__footer-links">
          ...
          <button type="button" className="picom-marketing-consent__settings-link" onClick={openMarketingConsentSettings}>
            Cookie settings
          </button>
